...
![用 v-for 把一个数组对应为一组元素](F:\gitbook\workspace\vue\img\用 v-for 把一个数组对应为一组元素.png)
...
![用 v-for 把一个数组对应为一组元素2](F:\gitbook\workspace\vue\img\用 v-for 把一个数组对应为一组元素2.png)
...
![一个对象的 v-for](F:\gitbook\workspace\vue\img\一个对象的 v-for.png)
...
![一个对象的 v-for2](F:\gitbook\workspace\vue\img\一个对象的 v-for2.png)
...
![一个对象的 v-for3](F:\gitbook\workspace\vue\img\一个对象的 v-for3.png)
